...
const CACHE_NAME = 'pontotrack-v4.4';
const STATIC_CACHE = 'pontotrack-static-v4.4';
const DYNAMIC_CACHE = 'pontotrack-dynamic-v4.4';
...
self.addEventListener('install', event => {
  console.log('[SW] Instalando Service Worker v4.3...');
  event.waitUntil(
